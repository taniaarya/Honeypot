...
log -k /root/Honeypot_Scripts/hacs.json -s https://docs.google.com/spreadsheets/d/10WP00Gvlu2ZmFNLv0u0APAG0IhS1JBWdGjQpifkqGAM/edit#gid=1962965854 -d "$date,$pram,$pdisk,$pload,$prxkb,$ptxkb,$cram,$cdisk,$cload,$crxkb,$ctxkb"
